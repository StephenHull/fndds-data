...
/// <summary>
/// This class contains functionaility for importing data for the ingredient nutrient
/// values table.
/// </summary>
public class IngredNutValImporter : DataImporter
{
    /// <summary>
    ...
    /// The logger class.
    /// </summary>
    private static readonly ILogger<IngredNutValImporter> _logger =
        new NLogLoggerFactory().CreateLogger<IngredNutValImporter>();
    ...
    /// <summary>
    /// Constructs a new IngredNutValImporter object.
    /// </summary>
    /// <param name="version">The FNDDS version.</param>
    /// <param name="connection">The connection to the source database.</param>
    /// <param name="context">The destination database context.</param>
    public IngredNutValImporter(FnddsVersion version, OleDbConnection connection, FnddsDbContext context)
